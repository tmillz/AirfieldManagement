...
public class EditMarkerCursorAdapter extends ResourceCursorAdapter {
	
	private static final int MAX_IMAGE_DIMENSION = 200;

	ImageButton imageButton;

	public EditMarkerCursorAdapter(Context context, int layout, Cursor cursor, int flags) {
	...
	public void bindView(View view, Context context, Cursor arg1) {
        ...
        TextView editDisc = (TextView) view.findViewById(R.id.editMarker);
		...
		TextView editColor = (TextView) view.findViewById(R.id.editColor);
		editColor.setText(arg1.getString(arg1.getColumnIndex(LocationsDB.FIELD_COLOR)));
		
		TextView editlat = (TextView) view.findViewById(R.id.editLat);
        editlat.setText(Double.toString(arg1.getDouble(arg1.getColumnIndex(LocationsDB.FIELD_LAT))));
        
        TextView editlng = (TextView) view.findViewById(R.id.editLng);
